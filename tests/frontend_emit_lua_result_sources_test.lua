...
local function test_emit_lua_supports_present_and_joined_result_sources()
    ...
    local out = build_summary_source(T, base_source):check():lower():define_machine():emit_lua()
    assert(#out.files == 2)
...
test_emit_lua_supports_present_and_joined_result_sources()

print("frontend_emit_lua_result_sources_test.lua: ok")
