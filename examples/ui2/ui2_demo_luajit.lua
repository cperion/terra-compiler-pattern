...
local Backend = require("examples.ui.backends.luajit_sdl_gl")
local RawText = require("examples.ui.backends.text_sdl_ttf")
local Schema = require("examples.ui2.ui2_schema")
local Demo = require("examples.ui2.backends.luajit_demo_support")
...
local runtime = Backend.init_window("ui2 demo (luajit)", 800, 600)
